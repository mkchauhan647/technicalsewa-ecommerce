...
const SimilarProducts = (props: any) => {
  ...
  return (
    <>
      <div className="">
        <h2 className="text-2xl font-bold text-[#333] mb-4 mt-4">
          Similar Products
        </h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 py-5 ">
          {featuredProducts
            ...
            .map((product: Product, index: number) => (
              <div
                className="w-[320px] lg:w-[245px] rounded-lg overflow-hidden relative  hover:shadow-lg  shadow-md cursor-pointer"
                key={index}
              >
                <Link
                  // href={{
